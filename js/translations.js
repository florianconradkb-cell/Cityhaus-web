var translations = {
  de: {
    ...
    kuenstler_intro: "Die Künstlerinnen und Künstler, deren Werke aktuell im Cityhaus zu sehen sind.",
    ...
    publikationen_title: "Publikationen",
    publikationen_intro: "Presseartikel über die Künstlerinnen und Künstler des Cityhaus.",

    kontakt_title: "Kontakt",
    kontakt_operator_label: "Trägerschaft:",
    kontakt_email_label: "E-Mail:",
    kontakt_email_placeholder: "[E-Mail-Adresse einfügen]",
    kontakt_phone_label: "Telefon:",
    kontakt_phone_placeholder: "[Telefonnummer einfügen]",
    kontakt_note: "Platzhalterangaben — bitte durch die tatsächliche Adresse, E-Mail und Telefonnummer ersetzen.",
  ...
  en: {
    ...
    kuenstler_intro: "The artists whose works are currently on show at Cityhaus.",
    ...
    publikationen_title: "Publications",
    publikationen_intro: "Press articles about the artists at Cityhaus.",

    kontakt_title: "Contact",
    kontakt_operator_label: "Operated by:",
    kontakt_email_label: "Email:",
    kontakt_email_placeholder: "[Insert email address]",
    kontakt_phone_label: "Phone:",
    kontakt_phone_placeholder: "[Insert phone number]",
    kontakt_note: "Placeholder details — please replace with the actual address, email and phone number.",
  ...
  fr: {
    ...
    kuenstler_intro: "Les artistes dont les œuvres sont actuellement exposées au Cityhaus.",
    ...
    kontakt_title: "Contact",
    kontakt_operator_label: "Organisme responsable :",
    kontakt_email_label: "E-mail :",
    kontakt_email_placeholder: "[Insérer l'adresse e-mail]",
    kontakt_phone_label: "Téléphone :",
    kontakt_phone_placeholder: "[Insérer le numéro de téléphone]",
    kontakt_note: "Coordonnées provisoires — à remplacer par l'adresse, l'e-mail et le numéro de téléphone réels.",
